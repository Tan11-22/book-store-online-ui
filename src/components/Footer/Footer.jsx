...
function Footer() {
  return (
    <div>
      <footer class="relative w-full mt-5">
        <div class="w-full px-8 mx-auto max-w-7xl">
            <div class="grid justify-between grid-cols-1 gap-4 md:grid-cols-2">
            <h5 class="block mb-6 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-inherit flex lg:flex  ml-5">
