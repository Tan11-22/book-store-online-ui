...
import { capNhatDMS, layCTDMS } from '../../../context/QuanTriSach'
import Alert from '../../Alert/Alert'

function FormXacNhanDuyet({data, open, onClose, refresh}) {
    ...
    const handleXacNhanDuyet= () => {
        const dataReq = {
         ...
         const fetchData = async () => {
                    try {
                      const result = await capNhatDMS(dataReq);
                      console.log(result)
                      if(result.code === 200) {
                      ...
                      <div role="alert" className="container mx-auto w-11/12 md:w-2/3 max-w-lg min-w-[800px] ">
                          <div className="relative py-8 px-5 md:px-10 bg-white shadow-md rounded-lg border border-black max-h-[80vh]  overflow-y-auto">
                              <div className="w-full flex justify-start text-gray-600 mb-3">
                                  ...
                                  <h1 className="text-gray-800 font-lg font-bold tracking-normal leading-tight mb-4 text-3xl pt-3 ml-4">Duyệt đơn mua sách</h1>
                              </div>
...
export default FormXacNhanDuyet
